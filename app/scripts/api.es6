...
export const getHealthFacilities = (healthFacilitiesQ, onProgress) =>
...
export const getEducation = (educationQ, onProgress) =>
...
export const getWaterStats = (waterQ, onProgress) =>
